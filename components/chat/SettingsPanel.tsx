  ...
  return (
    <>
      <div className="flex flex-none items-center gap-3 border-b-2 border-divider bg-surface px-4 py-3.5 sm:px-6">
        ...
        <span className="text-base font-extrabold">Configurações</span>
      </div>
      ...
      <div className="mx-auto w-full max-w-2xl flex-1 overflow-y-auto px-6 py-6 sm:px-8">
        <section className="flex flex-col gap-2.5 py-4">
          <h3 className="m-0 text-base">Sobre este assistente</h3>
        ...
        <section className="flex flex-col gap-2.5 py-4">
          <h3 className="m-0 text-base">Personas disponíveis</h3>
          ...
          <div className="mt-1 flex flex-col gap-2">
            {PERSONAS.map((p) => (
              <div key={p.id} className="flex flex-col gap-0.5 border-l-2 border-divider py-1 pl-3">
        ...
        <section className="flex flex-col gap-2.5 py-4">
          <h3 className="m-0 text-base">Backend ativo</h3>
          <div className="flex items-center gap-2.5">
            <span className="w-[150px] flex-none text-[12.5px] font-semibold text-muted">
              Provider de LLM
            </span>
